...
$sql = "SELECT * FROM peminjaman p INNER JOIN detail_peminjaman
        ON p.id_pinjam=detail_peminjaman.id_pinjam INNER JOIN buku b ON
        b.id_buku = detail_peminjaman.id_buku WHERE p.id_pinjam='$id_pinjam'";  
